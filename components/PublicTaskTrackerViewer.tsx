...
import { computeTimeToFinish, formatDate, rowAccentColor, STATUSES, TONE_COLORS } from "@/lib/tasktracker";
  ...
  return (
    <div className="w-full flex flex-col gap-6" style={{ maxWidth: 1600 }}>
      ...
      {loading ? (
        ...
        <details className="rounded-2xl border border-slate-200 bg-white shadow-sm mx-auto w-full" open>
                  ...
                  return (
                    <>
                      {openEntries.length > 0 && (
                        <tr>
                          <td colSpan={5} className="bg-slate-50 px-5 py-2 text-xs font-semibold text-slate-500">
